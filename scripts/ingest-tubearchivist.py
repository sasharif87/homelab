...
QDRANT_BASE  = os.environ.get("QDRANT_BASE",  "http://localhost:6333")
WEBUI_BASE   = os.environ.get("WEBUI_BASE",   "http://localhost:3000")
TA_BASE      = os.environ.get("TA_BASE",      "http://localhost:8000")
...
CATEGORIES = [
    {
        ...
        "match": [
            # e.g. "Level1Techs", "NetworkChuck", "Jeff Geerling",
            #      "TechnoTim", "Lawrence Systems", "DB Tech",
        ],
    },
    {
        ...
        "match": [
            # e.g. "Adam Savage", "This Old Tony", "DIY Perks", "AvE",
        ],
    },
    {
        ...
        "match": [
            # e.g. "Adam Ragusea", "Babish", "Ethan Chlebowski", "ChefSteps",
        ],
    },
    {
        ...
        "match": [
            # e.g. "Veritasium", "3Blue1Brown", "Practical Engineering", "Kurzgesagt",
        ],
    },
]
