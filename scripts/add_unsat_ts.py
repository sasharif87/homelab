...
Usage (from local Windows machine):
    ...
    python3 scripts/add_unsat_ts.py --dry-run

    # SCP and add everything (dupes are silently rejected by qBit)
    python3 scripts/add_unsat_ts.py
"""
...
TORRENT_DIR = r"C:\Users\<username>\Downloads\Unsat_Ts"
VM_HOST     = "root@<server-ip>"
VM_KEY      = r"C:\Users\<username>\.ssh\id_ed25519"
