param(
    ...
    [string]$ApiKey,
    [string]$BaseUrl = "http://192.168.50.48:3000"
)
...
$docs = @(
    ...
    "e:\coding\homelab\Docs\05_Architecture_Gaps.md",
    "e:\coding\homelab\Docs\06_Discord_Alternative_Decision.md",
    "e:\coding\homelab\Docs\07_Trackers_and_Indexers.md",
    "e:\coding\homelab\Docs\08_Forgejo_Git_Remote_Setup.md",
    "e:\coding\homelab\Docs\infra.md",
    "e:\coding\homelab\Docs\knowledge-archive.md",
