...
$SCP "$REPO_ROOT/scripts/boot/container-watchdog.py" "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/boot/boot-check.py"         "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/security/rootfs-guard.sh"    "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/boot/preflight-check.sh"    "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/boot/maintenance-reboot.sh" "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/boot/vm-reboot.sh"          "$VM:/opt/scripts/"
$SCP "$REPO_ROOT/scripts/security/trivy-weekly.sh"    "$VM:/opt/scripts/"
